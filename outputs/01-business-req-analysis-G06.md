...
- The binary relationship <code>has_user_role</code> connects its two participating entity types <code>User</code> and <code>UserRole</code> which have cardinalities <code>(0, 1)</code> and <code>(0, N)</code>, respectively.
