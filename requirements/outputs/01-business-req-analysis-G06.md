...
- The School will be organized into physical spaces to be booked <code>Space</code>. Their attributes are as follows:
	...
	- <code>building</code>: the building in which the space is located. For instance, auditorium I may be located in <code>Building I</code>, whereas classroom C34 may be located in <code>Building A</code>. *(NOTE: SHOULD BUILDING BE A SEPARATE ENTITY?)*